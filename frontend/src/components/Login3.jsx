...
// import "./Login3.css";
// import image from "./img/dis.jpg"; // Import your image
...
//         navigate("/distributors/dashboard"); // Redirect to the dashboard or desired page
//       }
//     } catch (error) {
