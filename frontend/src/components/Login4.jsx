...
// import "./Login4.css";
// import image from "./img/hph.webp"; // Import your image
...
//         "http://localhost:5000/api/hospitalspharmacies/login",
//         formData
//       );
...
//         navigate("/hospitalspharmacies/dashboard"); // Redirect to the dashboard or desired page
//       }
//     } catch (error) {
...
//               New user?{" "}
//               <Link
//                 to="/hospitalspharmacies/register"
//                 style={{
//                   textDecoration: "none",
//                   color: "#3498db",
//                 }}
...
import axios from "axios";
import "./Login4.css";
import image from "./img/hph.webp";
